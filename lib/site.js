...
export const NAV = [
  ...
  { label: "Associates", href: "/associates" },
  {
    ...
    href: "/services",
    children: [
      { label: "Corporate Wellness", href: "/about#corporate" },
      { label: "Health Talks & Workshops", href: "/services#features" },
    ],
  },
  {
    ...
    children: [
      {
        label: "Prof. Adrian Kennedy — Portfolio",
        href: "https://www.linkedin.com/in/adrian-kennedy-56081137/",
        external: true,
      },
      {
        label: "Dr. Hisham Al Omran — Portfolio",
        href: "https://www.linkedin.com/in/hisham-alomran-b3a4a0373/",
        external: true,
      },
    ],
  },
...
// ---------------------------------------------------------------------------
//  Team (About page) — photos via LinkedIn profile links.
//  NOTE: role labels below are best-effort; adjust as needed.
// ---------------------------------------------------------------------------
export const TEAM = [
  {
    name: "Dr Hisham Al Omran",
    role: "My Saudi Wellness",
    initials: "HA",
    photo: "team-hisham.jpg",
    linkedin: "https://www.linkedin.com/in/hisham-alomran-b3a4a0373/",
  },
  {
    name: "Prof Adrian Kennedy",
    role: "ActiveLife",
    initials: "AK",
    photo: "team-adrian.jpg",
    linkedin: "https://www.linkedin.com/in/adrian-kennedy-56081137/",
  },
  {
    name: "Dr Juan Diego Estrada",
    role: "Lifestyle Medicine",
    initials: "JE",
    photo: "team-juan.jpg",
    linkedin: "https://www.linkedin.com/in/juandiegoestrada/",
  },
];
