...
const CLIENTS = [
  ...
  { name: "AFW", file: "AFW-Logo.png" },
  { name: "Ahyush", file: "ahyushlogo.png" },
  { name: "DoubleTree", file: "Doubletree.svg" },
  { name: "Guardian Glass", file: "guardianglass.png" },
  { name: "Lafarge", file: "lafarge_logo_color.svg" },
  { name: "Neuron", file: "neuron.svg" },
  { name: "RAK", file: "rak-logo.png" },
  { name: "Saqr Port", file: "saqr.port_.logo_.jpg" },
  { name: "Saverglass", file: "saverglass.svg" },
  { name: "Stevin Rock", file: "stevinrock.png" },
];
